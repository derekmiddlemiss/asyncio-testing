...
@pytest.mark.asyncio
async def test_run_in_subprocess_cancellation():
    ...
    # Mock the logging to verify it's called
...
@pytest.mark.asyncio
async def test_run_in_subprocess_cancellation_during_creation():
    ...
    with patch('logging.error') as mock_log_error:
        ...
        with patch('asyncio.create_subprocess_shell', delayed_create_subprocess_shell):
